...
const ACCIONES_US: Asset[] = [
  ...
  { symbol: 'UNH', name: 'UnitedHealth', category: 'acciones-us', finnhubSymbol: 'UNH', basePrice: 525, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'LLY', name: 'Eli Lilly', category: 'acciones-us', finnhubSymbol: 'LLY', basePrice: 785, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'AVGO', name: 'Broadcom', category: 'acciones-us', finnhubSymbol: 'AVGO', basePrice: 1350, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'COST', name: 'Costco', category: 'acciones-us', finnhubSymbol: 'COST', basePrice: 725, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'ADBE', name: 'Adobe', category: 'acciones-us', finnhubSymbol: 'ADBE', basePrice: 520, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'TMO', name: 'Thermo Fisher', category: 'acciones-us', finnhubSymbol: 'TMO', basePrice: 570, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'ACN', name: 'Accenture', category: 'acciones-us', finnhubSymbol: 'ACN', basePrice: 325, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'ABBV', name: 'AbbVie', category: 'acciones-us', finnhubSymbol: 'ABBV', basePrice: 180, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'TXN', name: 'Texas Instruments', category: 'acciones-us', finnhubSymbol: 'TXN', basePrice: 195, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'DHR', name: 'Danaher', category: 'acciones-us', finnhubSymbol: 'DHR', basePrice: 245, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'WFC', name: 'Wells Fargo', category: 'acciones-us', finnhubSymbol: 'WFC', basePrice: 58, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'BAC', name: 'Bank of America', category: 'acciones-us', finnhubSymbol: 'BAC', basePrice: 38, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'C', name: 'Citigroup', category: 'acciones-us', finnhubSymbol: 'C', basePrice: 62, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'AXP', name: 'American Express', category: 'acciones-us', finnhubSymbol: 'AXP', basePrice: 235, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'BLK', name: 'BlackRock', category: 'acciones-us', finnhubSymbol: 'BLK', basePrice: 785, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'MS', name: 'Morgan Stanley', category: 'acciones-us', finnhubSymbol: 'MS', basePrice: 98, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'QCOM', name: 'Qualcomm', category: 'acciones-us', finnhubSymbol: 'QCOM', basePrice: 175, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'IBM', name: 'IBM', category: 'acciones-us', finnhubSymbol: 'IBM', basePrice: 185, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'CSCO', name: 'Cisco', category: 'acciones-us', finnhubSymbol: 'CSCO', basePrice: 50, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'VZ', name: 'Verizon', category: 'acciones-us', finnhubSymbol: 'VZ', basePrice: 40, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'T', name: 'AT&T', category: 'acciones-us', finnhubSymbol: 'T', basePrice: 17, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'CMCSA', name: 'Comcast', category: 'acciones-us', finnhubSymbol: 'CMCSA', basePrice: 42, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'PEP', name: 'PepsiCo', category: 'acciones-us', finnhubSymbol: 'PEP', basePrice: 175, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'PG', name: 'Procter & Gamble', category: 'acciones-us', finnhubSymbol: 'PG', basePrice: 162, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'HD', name: 'Home Depot', category: 'acciones-us', finnhubSymbol: 'HD', basePrice: 365, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'LOW', name: "Lowe's", category: 'acciones-us', finnhubSymbol: 'LOW', basePrice: 240, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'SBUX', name: 'Starbucks', category: 'acciones-us', finnhubSymbol: 'SBUX', basePrice: 90, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'TGT', name: 'Target', category: 'acciones-us', finnhubSymbol: 'TGT', basePrice: 165, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'GILD', name: 'Gilead Sciences', category: 'acciones-us', finnhubSymbol: 'GILD', basePrice: 72, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'AMGN', name: 'Amgen', category: 'acciones-us', finnhubSymbol: 'AMGN', basePrice: 285, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'MDLZ', name: 'Mondelez', category: 'acciones-us', finnhubSymbol: 'MDLZ', basePrice: 72, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'MU', name: 'Micron', category: 'acciones-us', finnhubSymbol: 'MU', basePrice: 120, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'NOW', name: 'ServiceNow', category: 'acciones-us', finnhubSymbol: 'NOW', basePrice: 775, currency: 'USD', flag: '🇺🇸' },
  { symbol: 'INTU', name: 'Intuit', category: 'acciones-us', finnhubSymbol: 'INTU', basePrice: 635, currency: 'USD', flag: '🇺🇸' },
